...
API = "bc87716f93247853f3d80fd3ce1e1cc4";
// --------------------- Created By Amit Bhatt ---------------------
...
const callAPI = (id) => {
    fetch(`https://api.openweathermap.org/data/2.5/weather?units=metrix&q=${searchInput.value}&appid=${id}`)
        .then(response => {
